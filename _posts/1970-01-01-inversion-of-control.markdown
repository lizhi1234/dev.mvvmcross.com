...
<div class="section-container tabs" data-section="tabs" data-options="deep_linking: true">
  <div class="section">
    <p class="title"><a href="#android">Android</a></p>
    <div class="content" data-slug="android">
...
{% endhighlight %}
  ...
  <div class="section">
    <p class="title"><a href="#ios">iOS</a></p>
    <div class="content" data-slug="ios">
...
{% endhighlight %}
  ...
  <div class="section">
    <p class="title"><a href="#windowsphone">Windows Phone</a></p>
    <div class="content" data-slug="windows8phone">
      <p>Windows Phone.</p>
    </div>
  </div>
  <div class="section">
    <p class="title"><a href="#windowsstore">Windows Store</a></p>
    <div class="content" data-slug="windowsstore">
      <p>Windows Store.</p>
    </div>
  </div>
</div>
